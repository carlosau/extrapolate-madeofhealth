          ...
          onSubmit={async (e) => {
            ...
            fetch("/api/upload", {
              ...
              if (res.status === 200) {
                ...
                setSaving(false);
                alert("Algo de errado ocorreu. Por favor, tente novamente.");
              }
            });
          }}
        >
          <div>
            ...
            >
              ...
              >
                ...
                Click and hold or click to add
                </p>
                <p className="mt-2 text-center text-sm text-gray-500">
                Recommended: 1:1 square aspect ratio, with a clear view of your face
                </p>
